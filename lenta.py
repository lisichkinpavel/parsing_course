...
for block in news_blocks:
    ...
    # дату на новость получаем из ссылки
    # лента также дает в новостях ссылки на какие-кто свои проекты moslenta и motor
    # там ссылки другого формата, так что их нужно обрабатывать иначе
